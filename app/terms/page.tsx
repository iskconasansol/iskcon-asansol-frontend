    ...
    <main className="py-16">
      <div className="p-4 container ">
        ...
        <p className="text-gray-500 text-sm">
          Last updated on 17-01-2024 15:30:41
        </p>

        <p className="mt-4 text-gray-700">
          These Terms and Conditions, along with privacy policy or other terms
          (“Terms”) constitute a binding agreement by and between <span className='font-semibold'>NAMHATTA
          DEVELOPMENT TRUST</span>, ( “Website Owner” or “we” or “us” or “our”) and you
          (“you” or “your”) and relate to your use of our website, goods (as
          applicable) or services (as applicable) (collectively, “Services”).By
          using our website and availing the Services, you agree that you have
          read and accepted these Terms (including the Privacy Policy). We
          ...
          these Terms to stay informed of updates.The use of this website or
          availing of our Services is subject to the following terms of use:
        </p>
        ...
        <ul className="list-disc list-inside mt-16">
          ...
          <li>
            ...
            be subject to the exclusive jurisdiction of the courts in Asansol,
            West Bengal
          </li>
          <li>
